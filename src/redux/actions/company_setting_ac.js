...
import { companySettingType, addCompanySettingType, updateCompanySettingType, pageCountType } from '../action_types'
...
export const fetchCompanySetting = (request = { rowCount: 9, pageCount: 0, sort: "id", desc: true }, requestType = 5, data = {}) => {
